function create_phase_avg_plot(freq,amp,nBins,nCycles)
% 
% created by:
% Prabu Sellappan - August 2010
% 
% usage:
% create_phase_avg_plot(freq,amp,nBins,nCycles)
%
...
stub=[stub 'phase_averaged_vorticity_nCycles_' int2str(nCycles) '.fig'];
cd('..');
% save figure
saveas(gcf,stub);
close;
